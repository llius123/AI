...
// ─── Skill Registration ───────────────────────────────────────────────────────
function registerSkill(server, skill, constraintsContent) {
...
async function main() {
    ...
    console.error(`MCP Server running on STDIO — skills registered: ${skillNames || "none"}`);
